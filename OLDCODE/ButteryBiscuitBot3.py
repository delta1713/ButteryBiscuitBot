...
PNOTES = """Version: """ + VNUMBER + """\n
 ...
 This hopefully will allow me (Jon) to add in quick song adding in the future. \n
 Also there is some better error handling, and a role limited !restart command \n
