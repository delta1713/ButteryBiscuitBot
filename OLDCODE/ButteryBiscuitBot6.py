...
#    songdict = dict(csv.reader(infile))
#print(songdict)
    ...
    try:
        ...
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            ...
            if duration <= 600:
                ...
                writesonglist(BEAUTIFULSONGS, "songlist2")
        ...
        context.message.channel.send("You do not have permission to do this.")
    except CommandInvokeError:
        context.message.channel.send("That is not a valid url")
