...
# =====================================================
#----------------- Test of class redesign--------------
# ======================================================

class Songclass:
    def __init__(self, name, url, context):
#        self.songid = 
        self.topname = name
        self.filepath = "/pythbot/Buttery_Biscuit_Bot/" + name + ".mp3"
        self.aliases = []
        self.protected = False
#        self.duration = checkurl()
...
async def acquire(context, *args):
    ...
    if await checksongname(filename, context) == True:
        ...
        pass
    if await checkurl(link, filelocation, context) <= 600:
        pass
    else:
        return
...
# List of text channels that the bot can be called to play songs from.
VALIDTEXTCHANNELS = [
    'Bobby Lobby',
    'General'
]
